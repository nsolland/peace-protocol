...
Until an explicit canonical transfer is recorded, the repository maintainer acts as editor of the public PEACE specification.
...
5. the change preserves implementation neutrality unless a separately named profile says otherwise;
6. the change does not make a provider or project maintainer a mandatory authority/intermediary;
...
2. identify the external canonical source and effective version/date;
