...
Until a dedicated private reporting address is published, use GitHub Security Advisories for this repository when available or contact the repository maintainer privately.
...
`NO_DIRECT_EFFECT_PATH` and fresh consequence-time authorization are security boundaries, not optional architecture preferences.
